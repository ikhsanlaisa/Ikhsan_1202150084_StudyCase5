package com.example.ikhsanlaisa.ikhsan_1202150084_studycase5.UI;
...
import com.example.ikhsanlaisa.ikhsan_1202150084_studycase5.DatabaseHandler;
import com.example.ikhsanlaisa.ikhsan_1202150084_studycase5.R;
import com.example.ikhsanlaisa.ikhsan_1202150084_studycase5.RecyclerAdapter;
import com.example.ikhsanlaisa.ikhsan_1202150084_studycase5.SwipeHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    private LinkedList<com.example.ikhsanlaisa.ikhsan_1202150084_studycase5.Model.Activity> mActivity = new LinkedList<>();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 1){
            ...
            databaseHandler.save(new com.example.ikhsanlaisa.ikhsan_1202150084_studycase5.Model.Activity(data.getStringExtra("activity"), data.getStringExtra("desc"), data.getStringExtra("priority")));
        }
        setRecyclerView();
